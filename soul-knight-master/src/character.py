...
class MySprite(pygame.sprite.Sprite):
    ...
    def load(self, filename, width, height, columns):
        ...
        self.rect = Rect(400,300,width,height)
...
class Monster0(MySprite):
    ...
    def update(self, current_time, rate=100):
        MySprite.update(self, current_time, rate)
        self.other[0]+=self.velocity[0]
        self.other[1]+=self.velocity[1]
        x = self.attack_target.X - self.other[0]########
        y = self.attack_target.Y - self.other[1]
